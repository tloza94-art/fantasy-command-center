const C="fantasy-cc-v18";
const SHELL=["./","./index.html","./styles.css","./app.js","./game-status-fix.js","./manager-ranking.js","./upgrade-popup.js","./sleeper-links.js","./manifest.webmanifest","./icons/icon.svg"];
